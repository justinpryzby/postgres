 ...
 *
 * XXX PGC_S_TEST is used when testing values to be used later.  For example,
...
#define GUC_DEFAULT_COMPILE	   0x010000	/* default is determined at compile time */
#define GUC_DEFAULT_INITDB	   0x020000	/* default is determined at during initdb */
