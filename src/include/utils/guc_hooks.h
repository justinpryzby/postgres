 ...
 *
 * is_test is used when testing values to be used later.  For example,
 ...
 * This is an interactive case, and
...
extern bool check_debug_io_direct(char **newval, void **extra, GucSource source, bool is_test);
...
extern bool check_default_tablespace(char **newval, void **extra,
									 GucSource source, bool is_test);
extern bool check_default_text_search_config(char **newval, void **extra, GucSource source, bool is_test);
...
extern bool check_locale_monetary(char **newval, void **extra, GucSource source, bool is_test);
extern void assign_locale_monetary(const char *newval, void *extra);
extern bool check_locale_numeric(char **newval, void **extra, GucSource source, bool is_test);
extern void assign_locale_numeric(const char *newval, void *extra);
extern bool check_locale_time(char **newval, void **extra, GucSource source, bool is_test);
...
extern bool check_log_timezone(char **newval, void **extra, GucSource source, bool is_test);
...
extern bool check_role(char **newval, void **extra, GucSource source, bool is_test);
...
extern bool check_timezone(char **newval, void **extra, GucSource source, bool is_test);
