...
#define ZS_INCOMPLETE_SRC (-6) /* cannot decompress unless full src message is fetched */
#define ZS_EXPAND_DST (-7) /* cannot compress: dst buffer is too small for given src size */
