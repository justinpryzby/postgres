 ...
 */
int			max_predicate_locks_per_xact = 64;	/* in guc_tables.c */
int			max_predicate_locks_per_relation = -2;	/* in guc_tables.c */
int			max_predicate_locks_per_page = 2;	/* in guc_tables.c */
