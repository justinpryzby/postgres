...
bool
check_shared_preload_libraries(char **newval, void **extra, GucSource source, bool is_test)
{
	return check_preload_libraries(newval, extra, source, false);
}

bool
check_local_preload_libraries(char **newval, void **extra, GucSource source, bool is_test)
{
	return check_preload_libraries(newval, extra, source, true);
}

bool
check_session_preload_libraries(char **newval, void **extra, GucSource source, bool is_test)
{
	return check_preload_libraries(newval, extra, source, false);
}
