...
static int	server_version_num = PG_VERSION_NUM;
...
static int	max_function_args = FUNC_MAX_ARGS;
static int	max_index_keys = INDEX_MAX_KEYS;
static int	max_identifier_length = NAMEDATALEN - 1;
static int	block_size = BLCKSZ;
static int	segment_size = RELSEG_SIZE;
static int	shared_memory_size_mb;
static int	shared_memory_size_in_huge_pages = -1; // XXX
static int	wal_block_size = XLOG_BLCKSZ;
...
const char *const GucSource_Names[] =
{
	...
	// [PGC_S_TEST] = "test",
	// [PGC_S_TEST_FUNCTION] = "test function",
